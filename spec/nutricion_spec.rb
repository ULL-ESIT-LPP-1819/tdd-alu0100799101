...
describe Nutricion do
    ...
    before :each do
        ...
        @etiqueta3 = Nutricion.new("Mermelada",0,0,0,0,17,4.2,5,0,6.4,0.5,0)
        @etiqueta4 = Nutricion.new("Inventada",8,5,10,0.6,20,5,1,4,11,2)
    ...
    describe"Pruebas practica 6" do
        ...
        it "Prueba Cantidad Grasa en KJ" do
            ...
            expect(@etiqueta3.valorgrasakj).to eq(37)
            expect(@etiqueta4.valorgrasakj).to eq(25.9)
        end
         it "Prueba Cantidad Grasa MonoSaturadas en KJ" do
            expect(@etiqueta1.valormonokj).to eq(0)
            expect(@etiqueta2.valormonokj).to eq(0)
            expect(@etiqueta3.valormonokj).to eq(37)
            expect(@etiqueta4.valormonokj).to eq(25.9)
        end
         it "Prueba Cantidad Polisaturadas en KJ" do
            ...
            expect(@etiqueta4.valorpolinkj).to eq(0)
        end
        it "Prueba Cantidad Hidratos en KJ" do
            ...
            expect(@etiqueta3.valorhidratoskj).to eq(79.9)
            expect(@etiqueta4.valorhidratoskj).to eq(0)
        end
         it "Prueba Cantidad Polialcohol en KJ" do
            expect(@etiqueta1.valorpolialkj).to eq(0)
            expect(@etiqueta2.valorpolialkj).to eq(0)
            expect(@etiqueta3.valorpolialkj).to eq(0)
            expect(@etiqueta4.valorpolialkj).to eq(0)
        end
         it "Prueba Cantidad Almidon en KJ" do
            ...
            expect(@etiqueta4.valoralmidonkj).to eq(0)
        end
          it "Prueba Cantidad Fibra en KJ" do
            expect(@etiqueta1.valorfibrakj).to eq(0)
            expect(@etiqueta2.valorfibrakj).to eq(0)
            expect(@etiqueta3.valorfibrakj).to eq(0)
            expect(@etiqueta4.valorfibrakj).to eq(0)
        end
        it "Prueba Cantidad Proteinas en KJ" do
            ...
            expect(@etiqueta4.valorproteinaskj).to eq(122.4)
        end
        it "Prueba Cantidad sal en KJ" do
            expect(@etiqueta1.valorsalkj).to eq(0.25)
            expect(@etiqueta2.valorsalkj).to eq(0.25)
            expect(@etiqueta3.valorsalkj).to eq(0.25)
            expect(@etiqueta4.valorsalkj).to eq(0.25)
        end
        it "Prueba Valor Energetico en KJ" do
            ...
            expect(@etiqueta2.valorenerkj).to eq(1457.5500000000002) 
             expect(@etiqueta3.valorenerkj).to eq(125.65)
            expect(@etiqueta4.valorenerkj).to eq(1457.5500000000002) 
        end
            it "Prueba Cantidad Grasa en Kcal" do
            expect(@etiqueta1.valorgrasakcal).to eq(9)
            expect(@etiqueta2.valorgrasakcal).to eq(6.3)
            expect(@etiqueta3.valorgrasakcal).to eq(9)
            expect(@etiqueta4.valorgrasakcal).to eq(6.3)
        end
        ...
        it "Prueba Cantidad Hidratos en Kcal" do
            ...
            expect(@etiqueta3.valorhidratoskcal).to eq(18.8)
            expect(@etiqueta4.valorhidratoskcal).to eq(308)
        end
         it "Prueba Cantidad Polialcohol en Kcal" do
            ...
            expect(@etiqueta3.valorpolialkcal).to eq(0)
            expect(@etiqueta4.valorpolialkcal).to eq(0)
        end
         it "Prueba Cantidad Almidon en Kcal" do
            ...
            expect(@etiqueta4.valoralmidonkcal).to eq(0)
        end
          it "Prueba Cantidad Fibra en Kcal" do
            expect(@etiqueta1.valorfibrakcal).to eq(0)
            expect(@etiqueta2.valorfibrakcal).to eq(0)
            expect(@etiqueta3.valorfibrakcal).to eq(0)
            expect(@etiqueta4.valorfibrakcal).to eq(0)
        end
        it "Prueba Cantidad Proteinas en Kcal" do
            ...
            expect(@etiqueta4.valorproteinaskcal).to eq(28.8)
        end
        it "Prueba Cantidad sal en Kcal" do
            expect(@etiqueta1.valorsalkcal).to eq(0.06)
            expect(@etiqueta2.valorsalkcal).to eq(0.06)
            expect(@etiqueta3.valorsalkcal).to eq(0.06)
            expect(@etiqueta4.valorsalkcal).to eq(0.06)
        end
        it "Prueba Valor Energetico en Kcal" do
            ...
            expect(@etiqueta3.valorenerkcal).to eq(29.86)
            expect(@etiqueta4.valorenerkcal).to eq(343.16) 
        end
        it "Prueba porcentaje %IR valorenergetico " do
           ...
           expect(@etiqueta3.valorenerir).to eq(1.4958333333333333)
           expect(@etiqueta4.valorenerir).to eq(17.351785714285718)
        end
        it "Prueba porcentaje %IR grasa" do
            ...
            expect(@etiqueta4.grasair).to eq(1)
        end
        it "Prueba porcentaje %IR Saturados" do
            ...
            expect(@etiqueta4.saturadasir).to eq(1)
        end
        it "Prueba porcentaje %IR hidratos" do
            ...
            expect(@etiqueta3.hidratosir).to eq(1.8076923076923077)
        ...
        it "Prueba porcentaje %IR Azucares" do
            ...
            expect(@etiqueta4.azucaresir).to eq(0.5555555555555556)
        end
        ...
        it "Prueba porcentaje %IR proteinas" do
            ...
            expect(@etiqueta4.proteinasir).to eq(14.400000000000002)
        end
        it "Prueba porcentaje %IR Sal" do
            ...
            expect(@etiqueta3.salir).to eq(0.16666666666666669)
            expect(@etiqueta4.salir).to eq(0.16666666666666669)
        end
